...
import com.polware.foodrecipes.data.utils.Constants.Companion.APP_DATASTORE
import com.polware.foodrecipes.data.utils.Constants.Companion.DATASTORE_PREFS_BACK_ONLINE
import com.polware.foodrecipes.data.utils.Constants.Companion.DATASTORE_PREFS_DIET_TYPE
import com.polware.foodrecipes.data.utils.Constants.Companion.DATASTORE_PREFS_DIET_TYPE_ID
import com.polware.foodrecipes.data.utils.Constants.Companion.DATASTORE_PREFS_MEAL_TYPE
import com.polware.foodrecipes.data.utils.Constants.Companion.DATASTORE_PREFS_MEAL_TYPE_ID
...
// Se define por fuera de la clase para ejecutar una sola instancia (evitar Exception)
...
class DataStoreRepository @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    val readMealAndDietType: Flow<MealAndDietType> = context.dataStore.data
        ...
        preferences ->
        // Si no hay valor almacenado para la Key invocada, se retorna un valor por defecto: "main course"
