...
import com.polware.foodrecipes.data.models.ExtendedIngredient
import com.polware.foodrecipes.data.utils.AdapterDiffUtil
import com.polware.foodrecipes.data.utils.Constants.Companion.BASE_IMAGE_URL
import com.polware.foodrecipes.databinding.IngredientItemLayoutBinding
...
class IngredientAdapter: RecyclerView.Adapter<IngredientAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(IngredientItemLayoutBinding
