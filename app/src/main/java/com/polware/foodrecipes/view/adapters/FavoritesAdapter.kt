...
import com.polware.foodrecipes.databinding.FavoriteItemLayoutBinding
import com.polware.foodrecipes.view.fragments.FavRecipesFragmentDirections
...
class FavoritesAdapter(private val fragActivity: FragmentActivity,
    ...
    /** Métodos que corresponden a "ActionMode.Callback" */
    ...
    // Cambiar el color del borde del CardView
    ...
    // Función que hace un Clear al ActionMode cuando cambiamos de pestaña Fragment
    fun clearActionMode() {
    ...
    /** Función para cambiar color de ActionBar al mostrar menú contextual */
