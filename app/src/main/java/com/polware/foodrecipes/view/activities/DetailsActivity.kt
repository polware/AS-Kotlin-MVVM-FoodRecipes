...
import com.polware.foodrecipes.databinding.ActivityDetailsBinding
import com.polware.foodrecipes.view.adapters.ViewPagerAdapter
import com.polware.foodrecipes.view.fragments.IngredientPageFragment
import com.polware.foodrecipes.view.fragments.InstructionPageFragment
import com.polware.foodrecipes.view.fragments.OverviewPageFragment
...
class DetailsActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        // Buscamos el ícono de Favorito (star)
    ...
    private fun checkFavoritesRecipe(menuItem: MenuItem) {
        mainViewModel.readFavorites.observe(this) {
            favoritesList ->
            try {
                // Buscamos en la tabla Favoritos si existe el Id de la receta mostrada
